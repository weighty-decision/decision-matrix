            ...
            form {
                ...
                div(classes = "actions") {
                    ...
                    form {
                        ...
                        attributes["hx-confirm"] = "Are you sure you want to delete the decision '${decision.name}'? This will permanently delete all criteria, options, and scores. This action cannot be undone."
