...
class StandardsBasedOAuthServiceTest {
    ...
    @Test fun `should handle callback with error parameter`() {
        // Given
    ...
    @Test fun `should handle callback with missing code`() {
        // Given
        val service = StandardsBasedOAuthService(testConfig)
    ...
    @Test fun `should handle callback with missing state`() {
        // Given
        val service = StandardsBasedOAuthService(testConfig)
    ...
    @Test fun `should handle callback with invalid state`() {
        // Given
        val service = StandardsBasedOAuthService(testConfig)
    ...
    @Test fun `should create authorization URL with default redirect`() {
    ...
    @Test fun `callback result classes should have proper structure`() {
        // Test Success result
